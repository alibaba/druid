...
public abstract class FilterAdapter extends NotificationBroadcasterSupport implements Filter {
	...
	@Override
	public BigDecimal callableStatement_getBigDecimal(FilterChain chain, CallableStatementProxy statement, int parameterIndex, int scale)
			throws SQLException {
	...
	@Override
	public java.io.Reader callableStatement_getCharacterStream(FilterChain chain, CallableStatementProxy statement, int parameterIndex)
			throws SQLException {
		return chain.callableStatement_getCharacterStream(statement, parameterIndex);
	}

	@Override
	public java.io.Reader callableStatement_getCharacterStream(FilterChain chain, CallableStatementProxy statement, String parameterName)
			throws SQLException {
	...
	@Override
	public java.sql.Date callableStatement_getDate(FilterChain chain, CallableStatementProxy statement, int parameterIndex, Calendar cal)
			throws SQLException {
	...
	@Override
	public java.sql.Date callableStatement_getDate(FilterChain chain, CallableStatementProxy statement, String parameterName, Calendar cal)
			throws SQLException {
	...
	@Override
	public java.io.Reader callableStatement_getNCharacterStream(FilterChain chain, CallableStatementProxy statement, int parameterIndex)
			throws SQLException {
		return chain.callableStatement_getNCharacterStream(statement, parameterIndex);
	}

	@Override
	public java.io.Reader callableStatement_getNCharacterStream(FilterChain chain, CallableStatementProxy statement, String parameterName)
			throws SQLException {
	...
	@Override
	public java.sql.Time callableStatement_getTime(FilterChain chain, CallableStatementProxy statement, int parameterIndex, Calendar cal)
			throws SQLException {
	...
	@Override
	public java.sql.Time callableStatement_getTime(FilterChain chain, CallableStatementProxy statement, String parameterName, Calendar cal)
			throws SQLException {
	...
	@Override
	public java.sql.Timestamp callableStatement_getTimestamp(FilterChain chain, CallableStatementProxy statement, String parameterName)
			throws SQLException {
	...
	@Override
	public void callableStatement_setBigDecimal(FilterChain chain, CallableStatementProxy statement, String parameterName, BigDecimal x)
			throws SQLException {
	...
	@Override
	public void callableStatement_setSQLXML(FilterChain chain, CallableStatementProxy statement, String parameterName, SQLXML xmlObject)
			throws SQLException {
	...
	@Override
	public void preparedStatement_setBlob(FilterChain chain, PreparedStatementProxy statement, int parameterIndex, InputStream inputStream)
			throws SQLException {
	...
	@Override
	public void preparedStatement_setSQLXML(FilterChain chain, PreparedStatementProxy statement, int parameterIndex, SQLXML xmlObject)
			throws SQLException {
	...
	@Override
	public void preparedStatement_setUnicodeStream(FilterChain chain, PreparedStatementProxy statement, int parameterIndex, java.io.InputStream x,
			int length) throws SQLException {
	...
	@Override
	public Object resultSet_getObject(FilterChain chain, ResultSetProxy result, String columnLabel, java.util.Map<String, Class<?>> map)
			throws SQLException {
	...
	@Override
	public void resultSet_updateAsciiStream(FilterChain chain, ResultSetProxy result, int columnIndex, java.io.InputStream x, int length)
			throws SQLException {
		chain.resultSet_updateAsciiStream(result, columnIndex, x, length);
	}

	@Override
	public void resultSet_updateAsciiStream(FilterChain chain, ResultSetProxy result, int columnIndex, java.io.InputStream x, long length)
			throws SQLException {
		chain.resultSet_updateAsciiStream(result, columnIndex, x, length);
	}
	...
	@Override
	public void resultSet_updateBinaryStream(FilterChain chain, ResultSetProxy result, int columnIndex, java.io.InputStream x, int length)
			throws SQLException {
		chain.resultSet_updateBinaryStream(result, columnIndex, x, length);
	}

	@Override
	public void resultSet_updateBinaryStream(FilterChain chain, ResultSetProxy result, int columnIndex, java.io.InputStream x, long length)
			throws SQLException {
		chain.resultSet_updateBinaryStream(result, columnIndex, x, length);
	}
	...
	@Override
	public void resultSet_updateBlob(FilterChain chain, ResultSetProxy result, String columnLabel, InputStream inputStream, long length)
			throws SQLException {
	...
	@Override
	public void resultSet_updateCharacterStream(FilterChain chain, ResultSetProxy result, int columnIndex, java.io.Reader x, int length)
			throws SQLException {
		chain.resultSet_updateCharacterStream(result, columnIndex, x, length);
	}

	@Override
	public void resultSet_updateCharacterStream(FilterChain chain, ResultSetProxy result, int columnIndex, java.io.Reader x, long length)
			throws SQLException {
		chain.resultSet_updateCharacterStream(result, columnIndex, x, length);
	}
	...
	@Override
	public void resultSet_updateNCharacterStream(FilterChain chain, ResultSetProxy result, int columnIndex, java.io.Reader x, long length)
			throws SQLException {
