...
public class WallFilter extends FilterAdapter implements WallFilterMBean {
    ...
    public final static String ATTR_CONTEXT   = "wall.ctx";
    ...
    private void setWallContext(StatementProxy statement) {
        String dbType = statement.getConnectionProxy().getDirectDataSource().getDbType();
        WallContext context = WallContext.create(dbType);
        statement.getAttributes().put(ATTR_CONTEXT, context);
    }
