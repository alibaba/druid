...
public interface OracleASTVisitor extends SQLASTVisitor {
    ...
    boolean visit(OracleXmlColumnProperties x);
    void endVisit(OracleXmlColumnProperties x);

    boolean visit(OracleXmlColumnProperties.OracleXMLTypeStorage x);
    void endVisit(OracleXmlColumnProperties.OracleXMLTypeStorage x);
}
