...
public class SQLLexer {
    ...
    /**
     * @param quoteMode if false: first <code>0x</code> has been skipped; if true: first <code>x'</code> has been
     * skipped
     */
    ...
    /**
     * @param quoteMode if false: first <code>0b</code> has been skipped; if true: first <code>b'</code> has been
     * skipped
     */
    ...
    /**
     * if first char is <code>.</code>, token may be {@link Token#DOT} if invalid char is presented after <code>.</code>
     */
    ...
    public String toString() {
        ...
        sb.append("curIndex=").append(curIndex).append(", ch=").append(ch).append(", token=").append(token).append(", sqlLeft=").append(sqlLeft).append(", sql=").append(buf);
        sb.append('}');
        return sb.toString();
    }
