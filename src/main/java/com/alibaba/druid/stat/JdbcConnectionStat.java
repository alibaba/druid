...
public class JdbcConnectionStat implements JdbcConnectionStatMBean {
	...
	public static class Entry implements EntryMBean {
		...
		private static String[] indexNames = { "id", "connectTime", "connectTimespan", "establishTime", "aliveTimespan", 
			"lastSql", "lastError", "lastErrorTime", "connectStatckTrace", "lastStatementStackTrace"
			, "dataSource" };
