 ...
 * 
 * 请求返回的json格式： {"ResultCode":1, "Content":
 ...
 * "WaitThreadCount"
 * :0,"NotEmptyWaitCount":0,"NotEmptyWaitMillis":0,"PoolingCount":1,
 * "PoolingPeak":0,"ActiveCount":0,"ActivePeak":1,"ActivePeakTime":
 * "Tue Aug 21 21:22:33 CST 2012",
 * "InitialSize":1,"MinIdle":1,"MaxActive":20,"QueryTimeout"
 * :0,"TransactionQueryTimeout":0,
 * "LoginTimeout":0,"ValidConnectionCheckerClassName"
 * :"com.alibaba.druid.pool.vendor.MySqlValidConnectionChecker",
 * "ExceptionSorterClassName"
 * :"com.alibaba.druid.pool.vendor.MySqlExceptionSorter",
 * "TestOnBorrow":false,"TestOnReturn"
 * :false,"TestWhileIdle":true,"DefaultAutoCommit":true,
 * "DefaultReadOnly":true,"LogicConnectCount"
 * :93,"LogicCloseCount":93,"LogicConnectErrorCount":0,
 * "PhysicalConnectCount":1,
 * "PhysicalCloseCount":0,"PhysicalConnectErrorCount":0,
 * "ExecuteCount":93,"ErrorCount"
 * :0,"CommitCount":0,"RollbackCount":0,"PSCacheAccessCount":31,
 * "PSCacheHitCount":30,"PSCacheMissCount":1,"StartTransactionCount":0,
 * "TransactionHistogram"
 * :[0,0,0,0,0,0],"ConnectionHoldTimeHistogram":[0,0,48,45,0,0,0,0],
