 ...
 * path</li>
 * <li><code>com/alibaba/druid/&#42;&#42;/*.jsp</code> - matches all <code>.jsp</code> files underneath the
 * <code>org/apache/shiro</code> path</li>
 * <li><code>com/&#42;&#42;/servlet/bla.jsp</code> - matches <code>com/alibaba/druid/servlet/bla.jsp</code> but also
 * <code>com/alibaba/druid/testing/servlet/bla.jsp</code> and <code>com/servlet/bla.jsp</code></li>
 * </ul>
 * <p>
 * <b>N.B.</b>: This class was borrowed (with much appreciation) from the <a href="http://shiro.apache.org">Shiro</a>
 * and the <a href="http://www.springframework.org">Spring Framework</a> with modifications. We didn't want to reinvent
 * the wheel of great work they've done, but also didn't want to force every Shiro user to depend on Spring
 * </p>
 * <p>
