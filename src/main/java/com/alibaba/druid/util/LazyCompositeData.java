 ...
 * interface. A CompositeData object will be lazily created only when the
 * CompositeData interface is used.
 * 
 * Classes that extends this abstract class will implement the
 * getCompositeData() method. The object returned by the getCompositeData() is
 * an instance of CompositeData such that the instance serializes itself as the
 * type CompositeDataSupport.
 */
