...
public class ManagedDataSource {
    ...
    /**
     * Creates an uninitialized datasource. Before this data source can be used a pool and transaction registry must be
     * set.
     */
     ...
     * XAConnectionFactory used to create the connection pool. If not an error will occure when attempting to use the
     * connection in a global transaction because the XAResource object associated with the connection will be
     * unavailable.
     * 
     * @param pool the connection pool
     * @param transactionRegistry the transaction registry obtained from the XAConnectionFactory used to create the
     * connection pool object factory
     */
