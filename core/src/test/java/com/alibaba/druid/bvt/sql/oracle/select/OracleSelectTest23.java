...
public class OracleSelectTest23 extends OracleTest {
    public void test_0() throws Exception {
        ...
        assertTrue(visitor.getTables().containsKey(new TableStat.Name("sys.obj$")));
        assertTrue(visitor.getTables().containsKey(new TableStat.Name("sys.user$")));
        assertTrue(visitor.getTables().containsKey(new TableStat.Name("dba_jobs")));

        assertEquals(9, visitor.getColumns().size());

        assertTrue(visitor.getColumns().contains(new TableStat.Column("sys.user$", "name")));
