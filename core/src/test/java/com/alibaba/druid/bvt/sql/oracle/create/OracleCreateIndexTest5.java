...
public class OracleCreateIndexTest5 extends OracleTest {
    public void test_0() throws Exception {
        ...
        assertTrue(visitor.getTables().containsKey(new TableStat.Name("FINANCE.SYS_JOURNAL_179871")));

        assertEquals(2, visitor.getColumns().size());

        assertTrue(visitor.getColumns().contains(new TableStat.Column("FINANCE.SYS_JOURNAL_179871", "RID")));
