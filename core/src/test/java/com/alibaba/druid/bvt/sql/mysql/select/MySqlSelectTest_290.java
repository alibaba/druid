...
public class MySqlSelectTest_290 extends MysqlTest {
    public void test_0() throws Exception {
        ...
        assertEquals(
            "SELECT houseInfo.id, contract.code, actualReceiMoney.actual_received_date, org.name AS orgName, org.id AS orgId\n"
