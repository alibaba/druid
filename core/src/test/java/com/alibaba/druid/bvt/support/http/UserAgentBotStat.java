...
public class UserAgentBotStat {
    ...
    public void test_youdao() throws Exception {
        ...
        assertEquals(1, stat.getBotCount());
        assertEquals(1, stat.getBotYoudaoCount());
    }
    ...
    public void test_bing() throws Exception {
        ...
        assertEquals(1, stat.getBotCount());
        assertEquals(1, stat.getBotBingCount());
    }
    ...
    public void test_google() throws Exception {
        ...
        assertEquals(1, stat.getBotCount());
        assertEquals(1, stat.getBotGoogleCount());
    }
    ...
    public void test_baidu() throws Exception {
        ...
        assertEquals(1, stat.getBotCount());
        assertEquals(1, stat.getBotBaiduCount());
    }
    ...
    public void test_soso() throws Exception {
        ...
        assertEquals(1, stat.getBotCount());
        assertEquals(1, stat.getBotSosoCount());
    }
    ...
    public void test_msn() throws Exception {
        ...
        assertEquals(1, stat.getBotCount());
        assertEquals(1, stat.getBotMsnCount());
    }
    ...
    public void test_sogou() throws Exception {
        ...
        assertEquals(1, stat.getBotCount());
        assertEquals(1, stat.getBotSogouCount());
    }
    ...
    public void test_yahoo() throws Exception {
        ...
        assertEquals(1, stat.getBotCount());
        assertEquals(1, stat.getBotYahooCount());
    }
