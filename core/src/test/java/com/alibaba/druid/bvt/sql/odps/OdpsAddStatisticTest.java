...
public class OdpsAddStatisticTest {
    ...
    public void test_expression_condition() throws Exception {
        ...
        assertEquals("ADD STATISTIC tbl_shop EXPRESSION_CONDITION tbl_shop = 'hangzhou';", SQLUtils.formatOdps(sql));
    }
}
