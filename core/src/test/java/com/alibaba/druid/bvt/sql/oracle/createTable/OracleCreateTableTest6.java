...
public class OracleCreateTableTest6 extends OracleTest {
    public void test_0() throws Exception {
        ...
        assertTrue(visitor.getTables().containsKey(new TableStat.Name("SYS.SYS_TEMP_0FD9D66FD_93E068F3")));

        assertEquals(2, visitor.getColumns().size());

        assertTrue(visitor.containsColumn("SYS.SYS_TEMP_0FD9D66FD_93E068F3", "C0"));
        assertTrue(visitor.containsColumn("SYS.SYS_TEMP_0FD9D66FD_93E068F3", "C1"));
