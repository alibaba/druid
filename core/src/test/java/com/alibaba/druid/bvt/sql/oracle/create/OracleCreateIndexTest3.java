...
public class OracleCreateIndexTest3 extends OracleTest {
    public void test_0() throws Exception {
        ...
        assertTrue(visitor.getTables().containsKey(new TableStat.Name("PRODUCT_ADDITION")));

        assertEquals(2, visitor.getColumns().size());

        assertTrue(visitor.getColumns().contains(new TableStat.Column("PRODUCT_ADDITION", "NEW_CLUSTER_ID")));
        assertTrue(visitor.getColumns().contains(new TableStat.Column("PRODUCT_ADDITION", "GMT_LAST_FEEDBACK")));
