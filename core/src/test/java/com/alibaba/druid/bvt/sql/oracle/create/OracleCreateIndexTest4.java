...
public class OracleCreateIndexTest4 extends OracleTest {
    public void test_0() throws Exception {
        ...
        assertTrue(visitor.getTables().containsKey(new TableStat.Name("SONAR.AUTHORS")));

        assertEquals(1, visitor.getColumns().size());

        assertTrue(visitor.getColumns().contains(new TableStat.Column("SONAR.AUTHORS", "LOGIN")));
