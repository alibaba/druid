...
public class PagerUtilsTest_hasUnorderedLimit_yashandb {
    @Test
    public void test_false() throws Exception {
        String sql = "SELECT *" +
                ...
                "\n\t) XXX" +
                "\nWHERE RN > 20";
        assertFalse(PagerUtils.hasUnorderedLimit(sql, JdbcConstants.YASHANDB));
    }
    ...
    public void test_true() throws Exception {
        String sql = "SELECT *" +
                "\nFROM t" +
                "\nWHERE ROWNUM <= 10";
        assertTrue(PagerUtils.hasUnorderedLimit(sql, JdbcConstants.YASHANDB));
    }
