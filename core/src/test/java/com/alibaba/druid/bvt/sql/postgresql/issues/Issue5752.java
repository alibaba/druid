...
//                "ALTER TABLE myschema.distributors SET SCHEMA yourschema;",
                ...
                parser = SQLParserUtils.createSQLStatementParser(statementList.get(0).toString(), dbType);
                statementList = parser.parseStatementList();
                System.out.println("重新解析再生成的sql===" + statementList);
            }
        }
    }
}
