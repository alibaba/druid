...
public class OdpsRemoveStatisticTest {
    ...
    public void test_expression_condition() throws Exception {
        ...
        assertEquals("REMOVE STATISTIC tbl_shop EXPRESSION_CONDITION tbl_shop = 'hangzhou';", SQLUtils.formatOdps(sql));
    }
}
