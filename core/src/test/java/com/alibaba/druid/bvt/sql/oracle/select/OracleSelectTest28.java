...
public class OracleSelectTest28 extends OracleTest {
    public void test_0() throws Exception {
        ...
        assertTrue(visitor.getTables().containsKey(new TableStat.Name("ESCROW.TRADE_PAY")));
        assertTrue(visitor.getTables().containsKey(new TableStat.Name("ESCROW.ESCROW_TRADE")));
        assertTrue(visitor.getTables().containsKey(new TableStat.Name("ESCROW.BUSINESS_ORDER")));
