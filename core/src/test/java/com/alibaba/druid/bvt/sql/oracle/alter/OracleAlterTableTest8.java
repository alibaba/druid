...
public class OracleAlterTableTest8 extends OracleTest {
    public void test_0() throws Exception {
        ...
        assertTrue(visitor.getTables().containsKey(new TableStat.Name("ws_i18n_translate_item")));

        assertEquals(1, visitor.getColumns().size());

        assertTrue(visitor.getColumns().contains(new TableStat.Column("ws_i18n_translate_item", "id")));
