 ...
 */
public class WallPerformanceTest_1 {
    private int times = 3;
    ...
    public void test_3() throws Exception {
        ...
        for (int i = 0; i < times; i++) {
            System.out.println("--3--use time：" + this.evaluate(sql, "mysql", 1000L));
        }
    }
    ...
    public void test_4() throws Exception {
        ...
        // System.out.println("sql: \n" + ParameterizedOutputVisitorUtils.parameterize(sql, JdbcUtils.SQL_SERVER));
        for (int i = 0; i < times; i++) {
            System.out.println("--4--use time：" + this.evaluate(sql, "mysql", 1000L));
        }
    }
    ...
    public void test_5() throws Exception {
        ...
        // System.out.println("sql: \n" + ParameterizedOutputVisitorUtils.parameterize(sql, JdbcUtils.SQL_SERVER));
        for (int i = 0; i < times; i++) {
            System.out.println("--5--use time：" + this.evaluate(sql, "mysql", 1000L));
        }
    }
