...
public enum SQLBinaryOperator {
    ...
    MATCH_ANY("MATCH_ANY", 110),
    NOT_MATCH_ANY("NOT MATCH_ANY", 110),
    MATCH_PHRASE("MATCH_PHRASE", 110),
    NOT_MATCH_PHRASE("NOT MATCH_PHRASE", 110),
    MATCH_PHRASE_PREFIX("MATCH_PHRASE_PREFIX", 110),
    NOT_MATCH_PHRASE_PREFIX("NOT MATCH_PHRASE_PREFIX", 110),
    MATCH_REGEXP("MATCH_REGEXP", 110),
    NOT_MATCH_REGEXP("NOT MATCH_REGEXP", 110),
