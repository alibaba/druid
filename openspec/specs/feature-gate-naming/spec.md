...
Define deterministic naming requirements for SQL parser feature gates so lexer/parser behavior flags remain readable, reviewable, and behavior-preserving during refactors.
